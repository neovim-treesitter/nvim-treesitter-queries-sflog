# nvim-treesitter-queries-sflog

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-sflog/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-sflog/actions/workflows/validate.yml)

Neovim tree-sitter queries for **sflog**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-sflog",
...
- [ ] Changes are scoped to `sflog` — do not include files for other languages
